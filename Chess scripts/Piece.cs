...
public class Rook : Piece
{
    ...
    public List<Vector2Int> LegalMoves(Board chessBoard)
    {
        ...
        if (GetTeam() == ChessGlobals.COLOR.WHITE)
        {
            ...
            while (i1 <= ChessGlobals.BoardConstants.BOARD_MAXIMUM && !chessBoard.IsOccupied(new Vector2Int(xCord, i1)))
            {
            ...
            i1 = yCord - 1;
            // if its empty, it can move there
            while (i1 >= ChessGlobals.BoardConstants.BOARD_MINIMUM && !chessBoard.IsOccupied(new Vector2Int(xCord, i1)))
            {
                positions.Add(new Vector2Int(xCord, i1));
                i1--;
            }
            ...
            i1 = xCord + 1;
            // if its empty, it can move there
            while (i1 <= ChessGlobals.BoardConstants.BOARD_MAXIMUM && !chessBoard.IsOccupied(new Vector2Int(i1, yCord)))
            {
            ...
            i1 = xCord - 1;
            // if its empty, it can move there
            while (i1 >= ChessGlobals.BoardConstants.BOARD_MINIMUM && !chessBoard.IsOccupied(new Vector2Int(i1, yCord)))
            {
                positions.Add(new Vector2Int(i1, yCord));
                i1--;
            }
...
public class Bishop : Piece
{
    ...
    public List<Vector2Int> LegalMoves(Board chessBoard)
    {
       ...
       // {
            ...
            int i2 = xc + 1;
            // if its empty, it can move there
            while (i1 <= ChessGlobals.BoardConstants.BOARD_MAXIMUM && i2 <= ChessGlobals.BoardConstants.BOARD_MAXIMUM && !chessBoard.IsOccupied(new Vector2Int(i2, i1)))
            {
            ...
            i2 = xc - 1;
            // if its empty, it can move there
            while (i1 >= ChessGlobals.BoardConstants.BOARD_MINIMUM && i2 >= ChessGlobals.BoardConstants.BOARD_MINIMUM && !chessBoard.IsOccupied(new Vector2Int(i2, i1)))
            {
                positions.Add(new Vector2Int(i2, i1));
                i1--;
                i2--;
            ...
            i2 = yc - 1;
            // if its empty, it can move there
            while (i1 <= ChessGlobals.BoardConstants.BOARD_MAXIMUM && i2 >= ChessGlobals.BoardConstants.BOARD_MINIMUM && !chessBoard.IsOccupied(new Vector2Int(i1, i2)))
            {
            ...
            // if its empty, it can move there
            while (i1 >= ChessGlobals.BoardConstants.BOARD_MINIMUM && i2 <= ChessGlobals.BoardConstants.BOARD_MAXIMUM && !chessBoard.IsOccupied(new Vector2Int(i1, i2)))
            {
                positions.Add(new Vector2Int(i1, i2));
                i1--;
                i2++;
        ...
        else
        {
            ...
            i2 = yc - 1;
            // if its empty, it can move there
            while (i1 < 8 && i2 > ChessGlobals.BoardConstants.BOARD_MINIMUM && !chessBoard.IsOccupied(new Vector2Int(i1, i2)))
            {
                positions.Add(new Vector2Int(i1, i2));
                i1++;
                i2--;
            ...
            i2 = yc - 1;
            // if its empty, it can move there
            while (i1 > ChessGlobals.BoardConstants.BOARD_MINIMUM && i2 > ChessGlobals.BoardConstants.BOARD_MINIMUM && !chessBoard.IsOccupied(new Vector2Int(i1, i2)))
            {
                positions.Add(new Vector2Int(i1, i2));
                i1--;
                i2--;
